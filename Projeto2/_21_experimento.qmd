...
**b. Salve os dados como um arquivo CSV.**

**c. Leia os dados em Julia com o pacote `DelimitedFiles.jl`, e com o pacote de vizualização de sua escolha, faça um gráfico `semilogx` dos seus resultados.**
```{julia}

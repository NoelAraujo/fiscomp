...
1. Dados 3 vetores  $\vec{a} = (1,-1,1)$,  $\vec{b} = (-3,1,5)$ e $\vec{c} = (4,-7,3)$ \footnote{Valores copiados de \cite{p1_ex2}} :
...
2. Voltaremos aos tempos de ensino médio, e vamos calcular tempo de queda livre $t_q = \sqrt{2h/g}$, porém não apenas na Terra.
...
4. Crie um programa para estimar o valor  de *sen(x)* através de sua expansão de Taylor truncada em $N$ elementos:
    $$
